...
local threshold_milliseconds = 500

local function debugPrint(message)
	if TrackpadKeys.config.debug then
		dbdf(3, os.date("%H:%M:%S") .. " [TrackpadKeys] " .. message)
	end
end

local function printGestureEvent(_, touch)
    debugPrint("Touch[" .. _ .. "] force:" .. touch.force);
    debugPrint("Touch force:" .. touch.force);
...
-- hs.hotkey.bind({"fn", "cmd"}, "t", function()
--     showMessage("TrackpadKeys Toggle")
--     TrackpadKeys.toggle()
-- end)
