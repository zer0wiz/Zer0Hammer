...
AutoHotKeys.__index = AutoHotKeys

-- Metadata
AutoHotKeys.name = "AutoHotKeys"
AutoHotKeys.version = "1.0"
AutoHotKeys.homepage = "https://github.com/Hammerspoon/Spoons"
AutoHotKeys.license = "MIT - https://opensource.org/licenses/MIT"

AutoHotKeys.logger = hs.logger.new('AutoHotKeys')
...
function testInitWithPidFailures()
  local app = hs.application.applicationForPID(6783)
  dbg(app:name())
end
...
function init()
  local app = findApplicationByName("Chrome")
  dbg(app:name())
  dbg(app:bundleID())
end
