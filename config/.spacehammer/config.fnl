...
(local app-bindings
       [return
        ...
        {:key :j
         :title "IntelliJ"
         :action (activator "Intellij IDEA Ultimate")}
        {:key :i
         :title "iTerm"
         :action (activator "iterm")}
        {:key :d
         :title "Dooray Messenger"
         :action (activator "Dooray Messenge")}
        ; {:key :b
        ;  :title "Brave"
...
(local intellij-config
       {:key "Intellij"
        :key [{:mods [:fn :shift]
               :action "intellij:translate-selection"
